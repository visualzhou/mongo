...
res = t.save( orig );
assert(!res.hasWriteErrors(), "save");


res = t.update( {} , { $inc: { "comments.0.rate_up" : 1 } , $push: { "comments.0.rate_ups" : 99 } } )
assert(!res.hasWriteErrors(), "comments.0.rate_up");
