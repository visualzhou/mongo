...
StatusWith<OpTime> SyncTail::multiApply(OperationContext* opCtx, MultiApplier::Operations ops) {
    ...
    std::vector<WorkerMultikeyPathInfo> multikeyVector(_writerPool->getStats().numThreads);
    {
        ...
        tracepoint(mongo, before_schedule_write_to_oplog);
        ...
        tracepoint(mongo, after_schedule_write_to_oplog);
        ...
        tracepoint(mongo, after_dispatch_writes);
        // Wait for writes to finish before applying ops.
        _writerPool->waitForIdle();
        tracepoint(mongo, after_oplog_write);
        ...
        tracepoint(mongo, after_write_consistency_markers);
        {
        ...
        tracepoint(mongo, after_oplog_application);
    }
